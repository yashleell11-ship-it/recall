...
fetched 2026-09-05. Schemes genuinely differ per subject — INT108 and CSE326
carry NO mid-term at LPU, so the app must not offer one for them.
...
SUBJECTS: dict[str, dict] = {
    "MTH174": {
        ...
        "credits": 4,
        "units": ["Matrix Algebra", "Linear Differential Equation-I",
                  "Linear Differential Equation-II", "Fourier Series",
                  "Multivariate Calculus", "Integral Calculus"],
...
# The app's earlier ad-hoc codes map onto the real LPU codes.
LEGACY_RENAMES = {"MATHS": "MTH174", "HTML": "CSE326"}
