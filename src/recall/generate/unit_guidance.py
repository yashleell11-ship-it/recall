...
#:
#: A unit is ABSENT from this table when its corpus cannot support any query —
#: not given an empty tuple, because `topics_for` already returns () for
#: "unresearched" and conflating the two would hide the finding. CSE111's
#: "Profile Creation" is the one such unit today: its only mapped source is
#: lpu-cse111-syllabus.pdf, whose single chunk `passage_is_usable` rejects, so
#: the pool is zero characters, and Figma, HackerRank, HackerEarth and Leetcode
#: each occur exactly once in all 33 files — inside that same syllabus listing.
#: Its lesson will be the model's own knowledge until material is fetched for
#: it, and saying so is more useful than six phrases that retrieve noise.
_UNIT_TOPICS: dict[str, dict[str, tuple[str, ...]]] = {
    "CSE111": {
        "Computer Languages": (
            "machine language instructions, opcode and operand",
            "assembly language mnemonics and the two-pass assembler",
            "high-level language abstraction and portability",
            "compiler compared with interpreter",
            "program development cycle stages",
            "algorithm design with pseudocode and flowcharts",
            "linking and loading in the compilation and execution process",
        ),
        "Computer Fundamentals": (
            "generations of computers: vacuum tubes, transistors, integrated circuits and microprocessors",
            "early calculating devices: abacus, Pascaline and the Analytical Engine",
            "characteristics of computers: speed, accuracy, diligence and versatility",
            "functional units of a computer: input, memory, CPU and output",
            "address bus, data bus and control bus",
            "hardware and software, system software and application software",
            "types of computers: supercomputer, mainframe, server and workstation",
        ),
        "Computer Hardware": (
            "CPU control unit, arithmetic logic unit and registers",
            "GPU parallel processing compared with a CPU",
            "input devices and output devices",
            "memory hierarchy from registers to secondary storage",
            "RAM compared with ROM, and DRAM against SRAM",
            "hard disk drive compared with solid-state drive",
        ),
        "Number Systems": (
            "base or radix and positional place value",
            "binary place weights and the binary point",
            "octal and hexadecimal digit sets and the hexadecimal digits A to F",
            "repeated division by the target base with remainders read in reverse",
            "repeated multiplication of a decimal fraction by the base",
            "grouping bits in threes for octal and in fours for hexadecimal",
        ),
        "Version Control": (
            "Git compared with GitHub",
            "installing Git and git config --global user.name",
            "git init and creating a local repository",
            "git add and the staging area",
            "git commit and the commit snapshot",
            "creating a new branch with git switch -c",
        ),
        "Modern AI Trends and Tools": (
            "introduction to AI: narrow AI, machine learning and natural language processing",
            "real life applications of AI in healthcare, education and finance",
            "generative AI and its types of output",
            "ChatGPT and Gemini as text generation tools",
            "image, video and animation generation tools, inpainting and outpainting",
            "Perplexity AI, NotebookLM and JenniAI as research tools",
            "good prompt versus poor prompt in prompt engineering",
            "ethical use of AI: bias, privacy and academic integrity",
        ),
    },
    "CSE326": {
        "HTML Fundamentals": (
            "client-server architecture and the HTTP request-response cycle",
            "void elements and boolean attributes",
            "relative and absolute URLs in an a element href",
            "the img element with alt, srcset and sizes",
            "the video and audio elements with source and track children",
            "inline SVG with viewBox and basic shapes",
        ),
        "Semantic HTML and Forms": (
            "sectioning content: the article, section, aside and nav elements",
            "WAI-ARIA landmark roles, states and the accessibility tree",
            "native form controls: label, fieldset, select and textarea",
            "form submission with method get, method post and enctype",
            "input types email, url, number, date and range",
            "constraint validation with required, pattern and ValidityState",
            "table markup with caption, th scope, colspan and rowspan",
        ),
        "Cascading Style Sheets": (
            "specificity of a selector and the cascade",
            "the box model and box-sizing border-box",
            "position relative, absolute, fixed and sticky",
            "flexbox main axis, cross axis and the flex shorthand",
            "grid-template-columns with fr units and minmax",
            "pseudo-classes and pseudo-elements with ::before and ::after",
            "CSS transitions and @keyframes animations",
        ),
        "JavaScript Fundamentals": (
            "typeof and the primitive data types",
            "== versus === equality and type coercion",
            "var, let and const scope, hoisting and closures",
            "function declarations, function expressions and arrow functions",
            "string methods and template literals",
            "array methods push, splice, slice and sort",
            "objects, dot notation and bracket notation",
            "if...else and switch conditional statements",
        ),
        "Interactive Web Development": (
            "querySelector, querySelectorAll and a static NodeList",
            "addEventListener, event bubbling and event delegation",
            "fetch, the Response object and response.json()",
            "localStorage and sessionStorage in the Web Storage API",
            "for, while and do...while loops",
            "map, filter and reduce as higher-order functions",
            "validating form input with a regular expression",
        ),
        "Web Application Development and Deployment": (
            "git init, git add, git commit and git push",
            "publishing a static site with GitHub Pages",
            "ES modules with export, import and type=module",
            "try...catch...finally and throwing errors",
            "promise chaining with then, catch and async await",
            "the browser developer tools: the Inspector, the console, the debugger and the network panel",
        ),
    },
    "INT108": {
        "Environment, Variables, Expressions and Statements": (
            "values and types, and the type() function",
            "variable names, keywords and identifier rules",
            "avoiding NameError when using variables",
            "operators and operands, true division and floor division",
            "order of operations and operator precedence",
            "operations on strings, concatenation and repetition",
        ),
        "Conditional and Iterative Statements": (
            "modulus operator and divisibility tests",
            "boolean expressions and the logic operators and, or, not",
            "conditional statements, elif chains and nested conditionals",
            "while statements and nested while loops",
            "for loop statement with range() and nested for loops",
            "random numbers in loops with random.randint",
            "encapsulation and generalization of a function",
        ),
        "Strings, Lists, Tuples and Dictionaries": (
            "string slices and string traversal",
            "the find function, looping and counting",
            "list operations, list slices and deletion",
            "list methods append, pop, remove and sort, and what they return",
            "mutability and tuples, tuple assignment and tuples as return values",
            "dictionary operations and methods",
            "aliasing and copying, shallow copy versus deep copy",
        ),
        "Functions and Recursion": (
            "function calls and return values",
            "type conversion and coercion with int(), float() and str()",
            "math functions and the math module",
            "adding new functions with the def statement",
            "parameters and arguments, default and keyword arguments",
            "local variables and the scope of a variable inside a function",
            "recursion and its use, base case and recursive case",
        ),
        "Classes, Objects and OOP Terminology": (
            "creating classes, the __init__ constructor and self",
            "accessing attributes, class attribute versus instance attribute",
            "class inheritance and super()",
            "overriding methods in a subclass",
            "data hiding and name mangling with a double underscore",
            "function overloading with default arguments and *args",
        ),
        "Files, Exceptions and Regular Expressions": (
            "text files, open() and the modes 'r', 'w' and 'a'",
            "reading from a file with read(), readline() and readlines()",
            "writing to a file with write(), and writing variables to a file",
            "pickling with pickle.dump and pickle.load",
            "try-except blocks, the else block and finally",
            "handling the ZeroDivisionError and FileNotFoundError exceptions",
            "using the match function, re.match versus re.search",
            "various types of regular expressions: character classes, quantifiers and greedy matching",
        ),
    },
    "INT335": {
        "Foundations of Learning, Creativity and Design Thinking": (
            "focused and diffuse modes of thinking",
            "learning frameworks and the VARK model",
            "functional fixedness and cognitive blocks",
            "creativity, invention and innovation",
            "Stanford d.school design thinking framework: Empathize, Define, Ideate, Prototype, Test",
            "IDEO Human-Centred Design Framework: Hear, Create and Deliver",
            "iterative design process versus the waterfall model",
        ),
        "Empathy, Observation and Problem Identification": (
            "field observation and the AEIOU framework",
            "computational empathy in software engineering",
            "qualitative and quantitative user research",
            "user interviews and inquiry techniques",
            "explicit and implicit user needs",
            "user personas and target archetypes",
            "empathy mapping and the Says, Thinks, Does, Feels quadrants",
        ),
        "Ideation and Creative Problem Solving": (
            "convergent and divergent thinking",
            "brainstorming rules and idea generation",
            "SCAMPER technique",
            "mind mapping and reverse thinking",
            "idea organisation and affinity clustering",
            "feasibility and relevance analysis",
            "idea screening matrices and weighted scores",
        ),
        "Product Design and Prototyping": (
            "low-fidelity and high-fidelity prototypes",
            "paper prototyping for digital products",
            "storyboarding user interactions",
            "wireframing rules and conventions",
            "user flows and core product features",
            "minimum viable product (MVP)",
        ),
        "Testing, Validation and Customer Experience": (
            "principles of neutral user testing",
            "feedback capture matrix quadrants",
            "customer journey mapping layers",
            "user touchpoints and pain points",
            "software usability and navigation",
            "accessibility in digital products",
        ),
        "Innovation Project, Re-Design and Product Presentation": (
            "principles of design iteration",
            "design refactoring and re-design",
            "strategic pivoting and continuous improvement",
            "NABC model: Need, Approach, Benefits per costs, Competition",
            "high-impact product presentation",
            "elevator pitching and product communication",
            "technical design case study",
        ),
    },
    "MEC103": {
        "Introduction to Engineering Drawing: Instruments, Line Types, Lettering, Dimensioning, Scales and Conic Sections": (
            "standard sizes of drawing sheets as per BIS",
            "types of lines and their conventional meanings",
            "single stroke lettering and the height of letters",
            "aligned and unidirectional systems of dimensioning",
            "representative fraction and length of scale",
            "eccentricity, focus and directrix of conic sections",
        ),
        "Projections of Points, Lines and Planes": (
            "position of a point above the HP and in front of the VP",
            "true length and true inclination of a line",
            "line inclined to both the HP and the VP",
            "horizontal trace and vertical trace of a line",
            "line view or edge view of a plane",
            "true shape of a plane parallel to the HP",
        ),
        "Orthographic Projections (including Projection of Regular Solids)": (
            "first angle projection and the position of the top view",
            "third angle projection and the relative position of views",
            "elevation and plan as the names of the front view and top view",
            "front view, top view and side view on the three reference planes",
            "classification of solids into polyhedra and solids of revolution",
            "solid with its axis perpendicular to the HP",
        ),
        "Sectional Views": (
            "cutting plane line as a long-dashed dotted narrow line with arrows",
            "section lines or cross-hatch lines at 45 degrees",
            "full section, half section and offset section",
            "revolved section and removed section",
            "true shape of the section",
            "sectional front view and sectional top view",
        ),
        "Development of Surfaces": (
            "parallel line development of a prism and cylinder",
            "radial line development of a cone and pyramid",
            "triangulation development of a transition piece",
            "double-curved surface such as a sphere",
            "stretch-out line equal to the perimeter of the base",
            "included angle of the sector for a cone development",
        ),
        "Isometric Projections": (
            "isometric axes at 120 degrees to each other",
            "isometric scale and the foreshortened length",
            "size comparison of isometric drawing and true isometric projection",
            "isometric lines and non-isometric lines",
            "four-centre method for a circle in isometric",
            "axonometric projection and pictorial drawing",
        ),
    },
    "MTH165": {
        "Matrix Methods and Linear Systems": (
