...
export const SHORTCUT_GROUPS: ShortcutGroup[] = [
  ...
  },
  {
    title: "Approve",
    rows: [
      { keys: ["j", "k"], joiner: "/", description: "Next / previous card" },
      { keys: ["a"], description: "Mark approve, then move on" },
      { keys: ["r"], description: "Mark reject, then move on" },
      { keys: ["u"], description: "Clear the mark on this card" },
      { keys: ["x"], description: "Add or remove from the selection" },
      { keys: ["A"], description: "Mark the whole selection approve" },
      { keys: ["R"], description: "Mark the whole selection reject" },
